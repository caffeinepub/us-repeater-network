...
const TONE_MODES = ['FM', 'FM/Digital', 'Digital', 'CTCSS', 'DCS', 'Tone Squelch'];
...
export default function RepeaterForm({ onSubmit, isSubmitting, submittedBy }: RepeaterFormProps) {
  ...
  const validate = () => {
    ...
    if (!/^\d{5}$/.test(form.zipCode)) newErrors.zipCode = 'Enter a valid 5-digit zip code';
    return newErrors;
  };
  ...
  const fieldClass = "bg-input border-border text-foreground placeholder:text-muted-foreground";
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="bg-secondary/30 rounded-lg p-4 border border-border space-y-4">
        <h3 className="font-tech font-semibold text-sm text-foreground uppercase tracking-wide">Basic Information</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="space-y-1.5">
            <Label className={labelClass}>Call Sign <span className="text-destructive">*</span></Label>
            <Input
              value={form.callSign}
      ...
      {/* RF Details */}
      <div className="bg-secondary/30 rounded-lg p-4 border border-border space-y-4">
        <h3 className="font-tech font-semibold text-sm text-foreground uppercase tracking-wide">RF Details</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="space-y-1.5">
            <Label className={labelClass}>Frequency (MHz) <span className="text-destructive">*</span></Label>
            <Input
          ...
          <div className="space-y-1.5">
            <Label className={labelClass}>Offset (MHz) <span className="text-destructive">*</span></Label>
            <Input
              value={form.offset}
          ...
          <div className="space-y-1.5">
            ...
            <Select value={form.toneMode} onValueChange={(v) => update('toneMode', v)}>
          ...
          <div className="space-y-1.5">
            ...
            <Select value={form.ctcssTone} onValueChange={(v) => update('ctcssTone', v)}>
              <SelectTrigger className={fieldClass}>
                <SelectValue />
              </SelectTrigger>
      ...
      {/* Location */}
      <div className="bg-secondary/30 rounded-lg p-4 border border-border space-y-4">
        <h3 className="font-tech font-semibold text-sm text-foreground uppercase tracking-wide">Location</h3>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div className="space-y-1.5">
            <Label className={labelClass}>Zip Code <span className="text-destructive">*</span></Label>
            <Input
              value={form.zipCode}
      ...
      {/* Operational Details */}
      <div className="bg-secondary/30 rounded-lg p-4 border border-border space-y-4">
        <h3 className="font-tech font-semibold text-sm text-foreground uppercase tracking-wide">Operational Details</h3>
