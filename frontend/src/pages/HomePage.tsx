...
import { Radio, Search, Star, Shield, BookOpen, Zap, Globe, Users } from "lucide-react";
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-lg text-muted-foreground max-w-xl mb-8">
                The most comprehensive ham radio repeater directory in the United States. Search
                live data from RepeaterBook.com and community-submitted GMRS repeaters.
              </p>
              <div className="flex flex-wrap gap-3 justify-center lg:justify-start">
                <Button asChild size="lg" className="bg-amber text-navy hover:bg-amber-dark font-bold">
                  <Link to="/directory">
                    <Search className="w-4 h-4 mr-2" />
                    Search Repeaters
                  </Link>
                </Button>
                <Button asChild size="lg" variant="outline" className="border-amber text-amber hover:bg-amber hover:text-navy">
                  <Link to="/submit">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Find repeaters, save favorites, and contribute to the community directory.
            </p>
          </div>
      ...
      <section className="bg-navy py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            RepeaterBook covers ham radio repeaters, but GMRS repeaters need community support.
            Submit your GMRS repeater to help others find it.
          </p>
          <Button asChild size="lg" className="bg-amber text-navy hover:bg-amber-dark font-bold">
            <Link to="/submit">
              <Radio className="w-4 h-4 mr-2" />
