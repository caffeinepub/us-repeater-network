    ...
    <Dialog open={open} onOpenChange={(v) => !v && onClose()}>
      <DialogContent className="max-w-lg bg-card border-border text-foreground max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-0">
          ...
          {repeater.dcsCode &&
            repeater.dcsCode !== "" &&
            repeater.dcsCode !== "N/A" && (
              <DetailRow label="DCS Code" value={repeater.dcsCode} mono />
            )}
          <DetailRow label="Mode" value={repeater.toneMode || "FM"} />
        </div>
        ...
        <div>
          ...
          />
          {repeater.sponsor && (
            <DetailRow label="Sponsor / Club" value={repeater.sponsor} />
          )}
        </div>
